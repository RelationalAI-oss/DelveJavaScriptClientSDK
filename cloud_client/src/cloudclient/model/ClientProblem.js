 ...
 * @module cloudclient/model/ClientProblem
 * @version 1.0.8
 */
class ClientProblem {
    /**
     * Constructs a new <code>ClientProblem</code>.
     * @alias module:cloudclient/model/ClientProblem
     ...
     * @param {module:cloudclient/model/ClientProblem} obj Optional instance to populate.
     * @return {module:cloudclient/model/ClientProblem} The populated <code>ClientProblem</code> instance.
     */
