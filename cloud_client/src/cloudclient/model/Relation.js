 ...
 * @module cloudclient/model/Relation
 * @version 1.0.8
 */
class Relation {
    /**
     * Constructs a new <code>Relation</code>.
     * @alias module:cloudclient/model/Relation
     * @param relKey {module:cloudclient/model/RelKey} 
     * @param type {module:cloudclient/model/Relation.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/Relation} obj Optional instance to populate.
     * @return {module:cloudclient/model/Relation} The populated <code>Relation</code> instance.
     */
...
/**
 * @member {Array.<Array.<module:cloudclient/model/AnyType>>} columns
 */
Relation.prototype['columns'] = undefined;

/**
 * @member {module:cloudclient/model/RelKey} rel_key
 */
Relation.prototype['rel_key'] = undefined;

/**
 * @member {module:cloudclient/model/Relation.TypeEnum} type
 * @default 'Relation'
 */
