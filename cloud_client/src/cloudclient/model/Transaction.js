 ...
 * @module cloudclient/model/Transaction
 * @version 1.0.8
 */
class Transaction {
    /**
     * Constructs a new <code>Transaction</code>.
     * @alias module:cloudclient/model/Transaction
     * @param abort {Boolean} 
     * @param dbname {String} 
     * @param mode {module:cloudclient/model/Transaction.ModeEnum} 
     * @param readonly {Boolean} 
     * @param type {module:cloudclient/model/Transaction.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/Transaction} obj Optional instance to populate.
     * @return {module:cloudclient/model/Transaction} The populated <code>Transaction</code> instance.
     */
...
/**
 * @member {Array.<module:cloudclient/model/LabeledAction>} actions
 */
...
/**
 * @member {module:cloudclient/model/Transaction.ModeEnum} mode
 * @default 'OPEN'
 */
...
/**
 * @member {module:cloudclient/model/Transaction.TypeEnum} type
 * @default 'Transaction'
 */
