 ...
 * @module cloudclient/model/AbstractProblem
 * @version 1.0.8
 */
class AbstractProblem {
    /**
     * Constructs a new <code>AbstractProblem</code>.
     * @alias module:cloudclient/model/AbstractProblem
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/AbstractProblem} obj Optional instance to populate.
     * @return {module:cloudclient/model/AbstractProblem} The populated <code>AbstractProblem</code> instance.
     */
