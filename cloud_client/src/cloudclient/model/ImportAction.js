 ...
 * @module cloudclient/model/ImportAction
 * @version 1.0.8
 */
class ImportAction {
    /**
     * Constructs a new <code>ImportAction</code>.
     * @alias module:cloudclient/model/ImportAction
     ...
     * @param {module:cloudclient/model/ImportAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/ImportAction} The populated <code>ImportAction</code> instance.
     */
