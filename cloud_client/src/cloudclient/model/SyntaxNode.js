 ...
 * @module cloudclient/model/SyntaxNode
 * @version 1.0.8
 */
class SyntaxNode {
    /**
     * Constructs a new <code>SyntaxNode</code>.
     * @alias module:cloudclient/model/SyntaxNode
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/SyntaxNode} obj Optional instance to populate.
     * @return {module:cloudclient/model/SyntaxNode} The populated <code>SyntaxNode</code> instance.
     */
