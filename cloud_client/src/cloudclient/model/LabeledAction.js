 ...
 * @module cloudclient/model/LabeledAction
 * @version 1.0.8
 */
class LabeledAction {
    /**
     * Constructs a new <code>LabeledAction</code>.
     * @alias module:cloudclient/model/LabeledAction
     * @param action {module:cloudclient/model/Action} 
     * @param name {String} 
     * @param type {module:cloudclient/model/LabeledAction.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/LabeledAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/LabeledAction} The populated <code>LabeledAction</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/Action} action
 */
...
/**
 * @member {module:cloudclient/model/LabeledAction.TypeEnum} type
