 ...
 * @module cloudclient/model/LoadDataActionResult
 * @version 1.0.8
 */
class LoadDataActionResult {
    /**
     * Constructs a new <code>LoadDataActionResult</code>.
     * @alias module:cloudclient/model/LoadDataActionResult
     ...
     * @param {module:cloudclient/model/LoadDataActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/LoadDataActionResult} The populated <code>LoadDataActionResult</code> instance.
     */
