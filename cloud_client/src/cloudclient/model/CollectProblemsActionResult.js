 ...
 * @module cloudclient/model/CollectProblemsActionResult
 * @version 1.0.8
 */
class CollectProblemsActionResult {
    /**
     * Constructs a new <code>CollectProblemsActionResult</code>.
     * @alias module:cloudclient/model/CollectProblemsActionResult
     ...
     * @param {module:cloudclient/model/CollectProblemsActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/CollectProblemsActionResult} The populated <code>CollectProblemsActionResult</code> instance.
     */
