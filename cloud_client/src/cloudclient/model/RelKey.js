 ...
 * @module cloudclient/model/RelKey
 * @version 1.0.8
 */
class RelKey {
    /**
     * Constructs a new <code>RelKey</code>.
     * @alias module:cloudclient/model/RelKey
     * @param name {String} 
     * @param type {module:cloudclient/model/RelKey.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/RelKey} obj Optional instance to populate.
     * @return {module:cloudclient/model/RelKey} The populated <code>RelKey</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/RelKey.TypeEnum} type
 * @default 'RelKey'
 */
