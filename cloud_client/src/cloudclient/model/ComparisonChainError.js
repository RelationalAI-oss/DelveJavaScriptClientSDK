 ...
 * @module cloudclient/model/ComparisonChainError
 * @version 1.0.8
 */
class ComparisonChainError {
    /**
     * Constructs a new <code>ComparisonChainError</code>.
     * @alias module:cloudclient/model/ComparisonChainError
     ...
     * @param {module:cloudclient/model/ComparisonChainError} obj Optional instance to populate.
     * @return {module:cloudclient/model/ComparisonChainError} The populated <code>ComparisonChainError</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/AnyType} node
 */
