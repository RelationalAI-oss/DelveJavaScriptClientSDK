 ...
 * @module cloudclient/model/SetOptionsAction
 * @version 1.0.8
 */
class SetOptionsAction {
    /**
     * Constructs a new <code>SetOptionsAction</code>.
     * @alias module:cloudclient/model/SetOptionsAction
     ...
     * @param {module:cloudclient/model/SetOptionsAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/SetOptionsAction} The populated <code>SetOptionsAction</code> instance.
     */
