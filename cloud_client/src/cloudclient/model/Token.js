 ...
 * @module cloudclient/model/Token
 * @version 1.0.8
 */
class Token {
    /**
     * Constructs a new <code>Token</code>.
     * @alias module:cloudclient/model/Token
     ...
     * @param {module:cloudclient/model/Token} obj Optional instance to populate.
     * @return {module:cloudclient/model/Token} The populated <code>Token</code> instance.
     */
