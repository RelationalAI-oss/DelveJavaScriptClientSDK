 ...
 * @module cloudclient/model/ParseActionResult
 * @version 1.0.8
 */
class ParseActionResult {
    /**
     * Constructs a new <code>ParseActionResult</code>.
     * @alias module:cloudclient/model/ParseActionResult
     ...
     * @param {module:cloudclient/model/ParseActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/ParseActionResult} The populated <code>ParseActionResult</code> instance.
     */
