 ...
 * @module cloudclient/model/Range
 * @version 1.0.8
 */
class Range {
    /**
     * Constructs a new <code>Range</code>.
     * @alias module:cloudclient/model/Range
     * @param area {module:cloudclient/model/Area} 
     * @param endByte {Number} 
     * @param startByte {Number} 
     * @param type {module:cloudclient/model/Range.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/Range} obj Optional instance to populate.
     * @return {module:cloudclient/model/Range} The populated <code>Range</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/Area} area
 */
...
/**
 * @member {module:cloudclient/model/AnyType} input
 */
...
/**
 * @member {module:cloudclient/model/Range.TypeEnum} type
 * @default 'Range'
 */
