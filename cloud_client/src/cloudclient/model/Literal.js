 ...
 * @module cloudclient/model/Literal
 * @version 1.0.8
 */
class Literal {
    /**
     * Constructs a new <code>Literal</code>.
     * @alias module:cloudclient/model/Literal
     ...
     * @param {module:cloudclient/model/Literal} obj Optional instance to populate.
     * @return {module:cloudclient/model/Literal} The populated <code>Literal</code> instance.
     */
