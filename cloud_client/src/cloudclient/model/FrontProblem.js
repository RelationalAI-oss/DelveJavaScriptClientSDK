 ...
 * @module cloudclient/model/FrontProblem
 * @version 1.0.8
 */
class FrontProblem {
    /**
     * Constructs a new <code>FrontProblem</code>.
     * @alias module:cloudclient/model/FrontProblem
     ...
     * @param {module:cloudclient/model/FrontProblem} obj Optional instance to populate.
     * @return {module:cloudclient/model/FrontProblem} The populated <code>FrontProblem</code> instance.
     */
