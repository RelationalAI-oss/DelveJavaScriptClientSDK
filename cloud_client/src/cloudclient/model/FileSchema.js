 ...
 * @module cloudclient/model/FileSchema
 * @version 1.0.8
 */
class FileSchema {
    /**
     * Constructs a new <code>FileSchema</code>.
     * @alias module:cloudclient/model/FileSchema
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/FileSchema} obj Optional instance to populate.
     * @return {module:cloudclient/model/FileSchema} The populated <code>FileSchema</code> instance.
     */
