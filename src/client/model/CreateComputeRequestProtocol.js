 ...
 * @module client/model/CreateComputeRequestProtocol
 * @version 1.0.8
 */
class CreateComputeRequestProtocol {
    /**
     * Constructs a new <code>CreateComputeRequestProtocol</code>.
     * @alias module:client/model/CreateComputeRequestProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/CreateComputeRequestProtocol} obj Optional instance to populate.
     * @return {module:client/model/CreateComputeRequestProtocol} The populated <code>CreateComputeRequestProtocol</code> instance.
     */
 ...
 */
CreateComputeRequestProtocol.prototype['display_name'] = undefined;
