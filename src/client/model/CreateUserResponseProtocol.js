 ...
 * @module client/model/CreateUserResponseProtocol
 * @version 1.0.8
 */
class CreateUserResponseProtocol {
    /**
     * Constructs a new <code>CreateUserResponseProtocol</code>.
     * @alias module:client/model/CreateUserResponseProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/CreateUserResponseProtocol} obj Optional instance to populate.
     * @return {module:client/model/CreateUserResponseProtocol} The populated <code>CreateUserResponseProtocol</code> instance.
     */
...
/**
 * @member {module:client/model/UserInfoProtocol} user
 */
