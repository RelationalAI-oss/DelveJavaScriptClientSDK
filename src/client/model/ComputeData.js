 ...
 * @module client/model/ComputeData
 * @version 1.0.8
 */
class ComputeData {
    /**
     * Constructs a new <code>ComputeData</code>.
     * @alias module:client/model/ComputeData
     */
    constructor() { 
     ...
     * @param {module:client/model/ComputeData} obj Optional instance to populate.
     * @return {module:client/model/ComputeData} The populated <code>ComputeData</code> instance.
     */
