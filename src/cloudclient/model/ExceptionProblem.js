 ...
 * @module cloudclient/model/ExceptionProblem
 * @version 1.0.8
 */
class ExceptionProblem {
    /**
     * Constructs a new <code>ExceptionProblem</code>.
     * @alias module:cloudclient/model/ExceptionProblem
     ...
     * @param {module:cloudclient/model/ExceptionProblem} obj Optional instance to populate.
     * @return {module:cloudclient/model/ExceptionProblem} The populated <code>ExceptionProblem</code> instance.
     */
