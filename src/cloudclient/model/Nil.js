 ...
 * @module cloudclient/model/Nil
 * @version 1.0.8
 */
class Nil {
    /**
     * Constructs a new <code>Nil</code>.
     * @alias module:cloudclient/model/Nil
     ...
     * @param {module:cloudclient/model/Nil} obj Optional instance to populate.
     * @return {module:cloudclient/model/Nil} The populated <code>Nil</code> instance.
     */
