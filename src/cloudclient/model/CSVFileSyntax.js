 ...
 * @module cloudclient/model/CSVFileSyntax
 * @version 1.0.8
 */
class CSVFileSyntax {
    /**
     * Constructs a new <code>CSVFileSyntax</code>.
     * @alias module:cloudclient/model/CSVFileSyntax
     ...
     * @param {module:cloudclient/model/CSVFileSyntax} obj Optional instance to populate.
     * @return {module:cloudclient/model/CSVFileSyntax} The populated <code>CSVFileSyntax</code> instance.
     */
