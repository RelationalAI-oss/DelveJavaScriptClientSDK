 ...
 * @module cloudclient/model/Appl
 * @version 1.0.8
 */
class Appl {
    /**
     * Constructs a new <code>Appl</code>.
     * @alias module:cloudclient/model/Appl
     * @extends module:cloudclient/model/SyntaxNode
     * @implements module:cloudclient/model/SyntaxNode
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/Appl} obj Optional instance to populate.
     * @return {module:cloudclient/model/Appl} The populated <code>Appl</code> instance.
     */
...
/**
 * @member {Array.<module:cloudclient/model/SyntaxNode>} arguments
 */
