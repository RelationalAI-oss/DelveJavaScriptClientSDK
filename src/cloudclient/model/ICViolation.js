 ...
 * @module cloudclient/model/ICViolation
 * @version 1.0.8
 */
class ICViolation {
    /**
     * Constructs a new <code>ICViolation</code>.
     * @alias module:cloudclient/model/ICViolation
     * @param relKey {module:cloudclient/model/RelKey} 
     * @param source {String} 
     * @param type {module:cloudclient/model/ICViolation.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/ICViolation} obj Optional instance to populate.
     * @return {module:cloudclient/model/ICViolation} The populated <code>ICViolation</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/ICViolation.TypeEnum} type
 * @default 'ICViolation'
 */
