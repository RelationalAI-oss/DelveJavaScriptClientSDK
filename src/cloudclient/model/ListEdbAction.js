 ...
 * @module cloudclient/model/ListEdbAction
 * @version 1.0.8
 */
class ListEdbAction {
    /**
     * Constructs a new <code>ListEdbAction</code>.
     * @alias module:cloudclient/model/ListEdbAction
     ...
     * @param {module:cloudclient/model/ListEdbAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/ListEdbAction} The populated <code>ListEdbAction</code> instance.
     */
