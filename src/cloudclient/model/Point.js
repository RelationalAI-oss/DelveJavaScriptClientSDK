 ...
 * @module cloudclient/model/Point
 * @version 1.0.8
 */
class Point {
    /**
     * Constructs a new <code>Point</code>.
     * @alias module:cloudclient/model/Point
     * @param column {Number} 
     * @param row {Number} 
     * @param type {module:cloudclient/model/Point.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/Point} obj Optional instance to populate.
     * @return {module:cloudclient/model/Point} The populated <code>Point</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/Point.TypeEnum} type
 * @default 'Point'
 */
