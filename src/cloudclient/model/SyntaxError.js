 ...
 * @module cloudclient/model/SyntaxError
 * @version 1.0.8
 */
class SyntaxError {
    /**
     * Constructs a new <code>SyntaxError</code>.
     * @alias module:cloudclient/model/SyntaxError
     ...
     * @param {module:cloudclient/model/SyntaxError} obj Optional instance to populate.
     * @return {module:cloudclient/model/SyntaxError} The populated <code>SyntaxError</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/SyntaxNode} next
 */
SyntaxError.prototype['next'] = undefined;

/**
 * @member {module:cloudclient/model/SyntaxNode} node
 */
SyntaxError.prototype['node'] = undefined;

/**
 * @member {module:cloudclient/model/LinkedList} trace
 */
