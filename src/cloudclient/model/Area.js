 ...
 * @module cloudclient/model/Area
 * @version 1.0.8
 */
class Area {
    /**
     * Constructs a new <code>Area</code>.
     * @alias module:cloudclient/model/Area
     * @param endPoint {module:cloudclient/model/Point} 
     * @param startPoint {module:cloudclient/model/Point} 
     * @param type {module:cloudclient/model/Area.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/Area} obj Optional instance to populate.
     * @return {module:cloudclient/model/Area} The populated <code>Area</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/Point} end_point
 */
Area.prototype['end_point'] = undefined;

/**
 * @member {module:cloudclient/model/Point} start_point
 */
Area.prototype['start_point'] = undefined;

/**
 * @member {module:cloudclient/model/Area.TypeEnum} type
 * @default 'Area'
 */
