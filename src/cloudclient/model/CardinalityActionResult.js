 ...
 * @module cloudclient/model/CardinalityActionResult
 * @version 1.0.8
 */
class CardinalityActionResult {
    /**
     * Constructs a new <code>CardinalityActionResult</code>.
     * @alias module:cloudclient/model/CardinalityActionResult
     ...
     * @param {module:cloudclient/model/CardinalityActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/CardinalityActionResult} The populated <code>CardinalityActionResult</code> instance.
     */
...
/**
 * @member {Array.<module:cloudclient/model/Relation>} result
 */
