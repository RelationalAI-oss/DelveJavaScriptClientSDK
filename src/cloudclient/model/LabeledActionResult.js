 ...
 * @module cloudclient/model/LabeledActionResult
 * @version 1.0.8
 */
class LabeledActionResult {
    /**
     * Constructs a new <code>LabeledActionResult</code>.
     * @alias module:cloudclient/model/LabeledActionResult
     * @param name {String} 
     * @param result {module:cloudclient/model/ActionResult} 
     * @param type {module:cloudclient/model/LabeledActionResult.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/LabeledActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/LabeledActionResult} The populated <code>LabeledActionResult</code> instance.
     */
...
/**
 * @member {module:cloudclient/model/ActionResult} result
 */
LabeledActionResult.prototype['result'] = undefined;

/**
 * @member {module:cloudclient/model/LabeledActionResult.TypeEnum} type
