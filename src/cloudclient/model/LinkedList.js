 ...
 * @module cloudclient/model/LinkedList
 * @version 1.0.8
 */
class LinkedList {
    /**
     * Constructs a new <code>LinkedList</code>.
     * @alias module:cloudclient/model/LinkedList
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/LinkedList} obj Optional instance to populate.
     * @return {module:cloudclient/model/LinkedList} The populated <code>LinkedList</code> instance.
     */
