 ...
 * @module cloudclient/model/ModifyWorkspaceAction
 * @version 1.0.8
 */
class ModifyWorkspaceAction {
    /**
     * Constructs a new <code>ModifyWorkspaceAction</code>.
     * @alias module:cloudclient/model/ModifyWorkspaceAction
     ...
     * @param {module:cloudclient/model/ModifyWorkspaceAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/ModifyWorkspaceAction} The populated <code>ModifyWorkspaceAction</code> instance.
     */
