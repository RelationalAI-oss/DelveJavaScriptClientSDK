 ...
 * @module cloudclient/model/InstallAction
 * @version 1.0.8
 */
class InstallAction {
    /**
     * Constructs a new <code>InstallAction</code>.
     * @alias module:cloudclient/model/InstallAction
     ...
     * @param {module:cloudclient/model/InstallAction} obj Optional instance to populate.
     * @return {module:cloudclient/model/InstallAction} The populated <code>InstallAction</code> instance.
     */
