 ...
 * @module cloudclient/model/JSONFileSyntax
 * @version 1.0.8
 */
class JSONFileSyntax {
    /**
     * Constructs a new <code>JSONFileSyntax</code>.
     * @alias module:cloudclient/model/JSONFileSyntax
     * @extends module:cloudclient/model/FileSyntax
     * @implements module:cloudclient/model/FileSyntax
     * @param type {String} 
     */
    constructor(type) { 
     ...
     * @param {module:cloudclient/model/JSONFileSyntax} obj Optional instance to populate.
     * @return {module:cloudclient/model/JSONFileSyntax} The populated <code>JSONFileSyntax</code> instance.
     */
