 ...
 * @module cloudclient/model/TransactionResult
 * @version 1.0.8
 */
class TransactionResult {
    /**
     * Constructs a new <code>TransactionResult</code>.
     * @alias module:cloudclient/model/TransactionResult
     * @param aborted {Boolean} 
     * @param type {module:cloudclient/model/TransactionResult.TypeEnum} 
     */
     ...
     * @param {module:cloudclient/model/TransactionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/TransactionResult} The populated <code>TransactionResult</code> instance.
     */
...
/**
 * @member {Array.<module:cloudclient/model/LabeledActionResult>} actions
 */
...
/**
 * @member {Array.<module:cloudclient/model/Relation>} output
 */
TransactionResult.prototype['output'] = undefined;

/**
 * @member {Array.<module:cloudclient/model/AbstractProblem>} problems
 */
...
/**
 * @member {module:cloudclient/model/TransactionResult.TypeEnum} type
