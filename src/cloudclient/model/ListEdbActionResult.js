 ...
 * @module cloudclient/model/ListEdbActionResult
 * @version 1.0.8
 */
class ListEdbActionResult {
    /**
     * Constructs a new <code>ListEdbActionResult</code>.
     * @alias module:cloudclient/model/ListEdbActionResult
     ...
     * @param {module:cloudclient/model/ListEdbActionResult} obj Optional instance to populate.
     * @return {module:cloudclient/model/ListEdbActionResult} The populated <code>ListEdbActionResult</code> instance.
     */
...
/**
 * @member {Array.<module:cloudclient/model/RelKey>} rels
 */
