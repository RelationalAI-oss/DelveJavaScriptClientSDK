 ...
 * @module cloudclient/model/OutputProblem
 * @version 1.0.8
 */
class OutputProblem {
    /**
     * Constructs a new <code>OutputProblem</code>.
     * @alias module:cloudclient/model/OutputProblem
     ...
     * @param {module:cloudclient/model/OutputProblem} obj Optional instance to populate.
     * @return {module:cloudclient/model/OutputProblem} The populated <code>OutputProblem</code> instance.
     */
