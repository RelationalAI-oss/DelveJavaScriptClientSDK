 ...
 * @module cloudclient/model/InfraError
 * @version 1.0.8
 */
class InfraError {
    /**
     * Constructs a new <code>InfraError</code>.
     * @alias module:cloudclient/model/InfraError
     * @param status {String} 
     ...
     * @param {module:cloudclient/model/InfraError} obj Optional instance to populate.
     * @return {module:cloudclient/model/InfraError} The populated <code>InfraError</code> instance.
     */
