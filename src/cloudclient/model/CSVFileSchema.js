 ...
 * @module cloudclient/model/CSVFileSchema
 * @version 1.0.8
 */
class CSVFileSchema {
    /**
     * Constructs a new <code>CSVFileSchema</code>.
     * @alias module:cloudclient/model/CSVFileSchema
     ...
     * @param {module:cloudclient/model/CSVFileSchema} obj Optional instance to populate.
     * @return {module:cloudclient/model/CSVFileSchema} The populated <code>CSVFileSchema</code> instance.
     */
