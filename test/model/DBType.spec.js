...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DelveClientSdk.DBType();
  });
  ...
  describe('DBType', function() {
    it('should create an instance of DBType', function() {
      // uncomment below and update the code to test DBType
      //var instane = new DelveClientSdk.DBType();
      //expect(instance).to.be.a(DelveClientSdk.DBType);
    });
