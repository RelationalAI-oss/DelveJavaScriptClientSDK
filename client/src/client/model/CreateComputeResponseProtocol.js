 ...
 * @module client/model/CreateComputeResponseProtocol
 * @version 1.0.8
 */
class CreateComputeResponseProtocol {
    /**
     * Constructs a new <code>CreateComputeResponseProtocol</code>.
     * @alias module:client/model/CreateComputeResponseProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/CreateComputeResponseProtocol} obj Optional instance to populate.
     * @return {module:client/model/CreateComputeResponseProtocol} The populated <code>CreateComputeResponseProtocol</code> instance.
     */
...
/**
 * @member {module:client/model/ComputeData} compute_data
 */
