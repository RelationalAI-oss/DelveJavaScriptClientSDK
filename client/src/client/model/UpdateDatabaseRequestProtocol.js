 ...
 * @module client/model/UpdateDatabaseRequestProtocol
 * @version 1.0.8
 */
class UpdateDatabaseRequestProtocol {
    /**
     * Constructs a new <code>UpdateDatabaseRequestProtocol</code>.
     * @alias module:client/model/UpdateDatabaseRequestProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/UpdateDatabaseRequestProtocol} obj Optional instance to populate.
     * @return {module:client/model/UpdateDatabaseRequestProtocol} The populated <code>UpdateDatabaseRequestProtocol</code> instance.
     */
 ...
 */
UpdateDatabaseRequestProtocol.prototype['display_name'] = undefined;
