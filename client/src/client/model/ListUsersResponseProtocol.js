 ...
 * @module client/model/ListUsersResponseProtocol
 * @version 1.0.8
 */
class ListUsersResponseProtocol {
    /**
     * Constructs a new <code>ListUsersResponseProtocol</code>.
     * @alias module:client/model/ListUsersResponseProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/ListUsersResponseProtocol} obj Optional instance to populate.
     * @return {module:client/model/ListUsersResponseProtocol} The populated <code>ListUsersResponseProtocol</code> instance.
     */
...
/**
 * @member {Array.<module:client/model/UserInfoProtocol>} users
 */
