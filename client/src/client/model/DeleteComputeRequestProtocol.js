 ...
 * @module client/model/DeleteComputeRequestProtocol
 * @version 1.0.8
 */
class DeleteComputeRequestProtocol {
    /**
     * Constructs a new <code>DeleteComputeRequestProtocol</code>.
     * @alias module:client/model/DeleteComputeRequestProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/DeleteComputeRequestProtocol} obj Optional instance to populate.
     * @return {module:client/model/DeleteComputeRequestProtocol} The populated <code>DeleteComputeRequestProtocol</code> instance.
     */
