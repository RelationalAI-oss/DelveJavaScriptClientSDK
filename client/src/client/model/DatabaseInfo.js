 ...
 * @module client/model/DatabaseInfo
 * @version 1.0.8
 */
class DatabaseInfo {
    /**
     * Constructs a new <code>DatabaseInfo</code>.
     * @alias module:client/model/DatabaseInfo
     */
    constructor() { 
     ...
     * @param {module:client/model/DatabaseInfo} obj Optional instance to populate.
     * @return {module:client/model/DatabaseInfo} The populated <code>DatabaseInfo</code> instance.
     */
