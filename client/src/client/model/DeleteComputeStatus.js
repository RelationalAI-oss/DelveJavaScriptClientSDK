 ...
 * @module client/model/DeleteComputeStatus
 * @version 1.0.8
 */
class DeleteComputeStatus {
    /**
     * Constructs a new <code>DeleteComputeStatus</code>.
     * @alias module:client/model/DeleteComputeStatus
     */
    constructor() { 
     ...
     * @param {module:client/model/DeleteComputeStatus} obj Optional instance to populate.
     * @return {module:client/model/DeleteComputeStatus} The populated <code>DeleteComputeStatus</code> instance.
     */
