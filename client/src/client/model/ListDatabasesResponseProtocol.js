 ...
 * @module client/model/ListDatabasesResponseProtocol
 * @version 1.0.8
 */
class ListDatabasesResponseProtocol {
    /**
     * Constructs a new <code>ListDatabasesResponseProtocol</code>.
     * @alias module:client/model/ListDatabasesResponseProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/ListDatabasesResponseProtocol} obj Optional instance to populate.
     * @return {module:client/model/ListDatabasesResponseProtocol} The populated <code>ListDatabasesResponseProtocol</code> instance.
     */
...
/**
 * @member {Array.<module:client/model/DatabaseInfo>} databases
 */
