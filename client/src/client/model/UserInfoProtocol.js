 ...
 * @module client/model/UserInfoProtocol
 * @version 1.0.8
 */
class UserInfoProtocol {
    /**
     * Constructs a new <code>UserInfoProtocol</code>.
     * @alias module:client/model/UserInfoProtocol
     */
    constructor() { 
     ...
     * @param {module:client/model/UserInfoProtocol} obj Optional instance to populate.
     * @return {module:client/model/UserInfoProtocol} The populated <code>UserInfoProtocol</code> instance.
     */
